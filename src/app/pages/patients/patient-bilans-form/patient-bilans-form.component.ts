...
import {constants, prescriptions_types, bilans_types} from "../../../shared/constants";

@Component({
  selector: 'app-patient-bilans-form',
  templateUrl: './patient-bilans-form.component.html',
  styleUrls: ['./patient-bilans-form.component.scss']
})
export class PatientBilansFormComponent implements OnInit {
  ...
  async onSubmit() {
    ...
    this.isLoading = true;
    this.patientsService.save_bilans(this.selectedElement.id, this.data).subscribe(
      (result) => {
