...
import { medicines_types } from 'src/app/shared/constants';
...
export class MedicinesListComponent implements OnInit {
  ...
  constructor(private medicinesService: MedicinesService, private translate: TranslateService) { }
  ...
  toggleStatusChange(data) {
    ...
    this.isLoading = true;
    this.medicinesService.status(data.id, {enabled: data.status}).subscribe(
      (result) => {
  ...
  onLoad() {
    ...
    console.log(filters)
    this.medicinesService.all({params: filters}).subscribe(
      (result) => {
        console.log(result)
  ...
  exportData() {
    ...
    this.medicinesService.all({params: filters, responseType: 'blob' as 'json'}).subscribe(
      (result) => {
        console.log(result);
